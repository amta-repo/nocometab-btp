      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
        ...
        <div className="max-w-6xl mx-auto mt-12 md:mt-16">
          <h2 className="text-xl md:text-2xl font-bold text-foreground mb-6">
            {language === 'fr' ? 'Découvrir Aussi' : 'Also Discover'}
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3">
            {[
              { path: '/projects', labelFr: 'Tous nos Projets', labelEn: 'All Our Projects' },
              { path: '/services', labelFr: 'Nos Services', labelEn: 'Our Services' },
              { path: '/gallery', labelFr: 'Galerie Photos', labelEn: 'Photo Gallery' },
              { path: '/contact', labelFr: 'Nous Contacter', labelEn: 'Contact Us' },
            ].map(link => (
