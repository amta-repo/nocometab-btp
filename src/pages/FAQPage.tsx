...
const FAQPage = () => {
  ...
  const faqsEn: FAQ[] = [
    ...
    { category: 'Pricing & Quotes', question: 'How to get a free quote for my metal construction project?', answer: "Contact NOCOMETAB BTP by phone (+229 01 95 95 47 63), WhatsApp (+229 95 95 47 63), or email (nocometabbtp@gmail.com). Describe your project (surface area, building type, location) and we'll send a detailed quote within 48 hours. Site visits are free in Cotonou and surroundings." },
