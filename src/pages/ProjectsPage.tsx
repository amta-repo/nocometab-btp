      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
        ...
        <div className="max-w-6xl mx-auto mt-12 md:mt-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3">
            {[
              { path: '/services', labelFr: 'Nos Services', labelEn: 'Our Services' },
              { path: '/gallery', labelFr: 'Galerie Complète', labelEn: 'Full Gallery' },
              { path: '/about', labelFr: 'À Propos de NOCOMETAB', labelEn: 'About NOCOMETAB' },
              { path: '/contact', labelFr: 'Demander un Devis', labelEn: 'Request a Quote' },
            ].map(link => (
